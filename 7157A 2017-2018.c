...
#pragma config(Motor,  port2,           clawRotationSolo, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           armLeft2,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           armLeft1,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           driveLeftMotor, tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port6,           driveRightMotor, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           armRight1,     tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           armRight2,     tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           clawSolo,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          liftRight,     tmotorVex393_HBridge, openLoop, reversed)
