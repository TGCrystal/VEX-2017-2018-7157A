...
#pragma config(Motor,  port1,           driveLeftFront, tmotorVex393_HBridge, openLoop, reversed)
#pragma config(Motor,  port2,           driveRightRear, tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port9,           driveLeftRear, tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port10,          driveRightFront, tmotorVex393_HBridge, openLoop)
